...
Partial Class frmMainChart
    ...
    Friend WithEvents txtOprationType As Telerik.WinControls.UI.RadTextBox
    ...
    Friend WithEvents txtVaccume As Telerik.WinControls.UI.RadTextBox
    ...
    Friend WithEvents txtBhukaWt As Telerik.WinControls.UI.RadTextBox
