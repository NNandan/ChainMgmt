...
Public Class frmStockSampleBagCreated
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper(ConfigurationManager.ConnectionStrings("ConString").ToString())
    Private Sub frmStockSampleBagCreated_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Function
    Private Sub frmStockSampleBagCreated_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
