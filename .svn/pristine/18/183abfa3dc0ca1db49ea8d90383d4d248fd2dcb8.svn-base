        ...
        If cmbLotNo.SelectedIndex <> -1 Then
            ...
            Try
                ...
                If dr.HasRows Then
                    lvList.BeginUpdate()
                    While dr.Read
                        Dim lvi As ListViewItem = New ListViewItem(dr("TransactionId").ToString())
    ...
    Private Sub Validate_EditFields()
        Try
            ...
            If CheckBhukaBag(txtTransNo.Text.Trim) = False Then        ''Check Bhuka Bag Made
                MessageBox.Show("Bhuka Bag Made !!!", "Record", MessageBoxButtons.OK, MessageBoxIcon.Information)
                txtBhukaWt.Enabled = False
            ...
            If CheckSampleBag(txtTransNo.Text.Trim()) = False Then      ''Check Sample Bag Made
                MessageBox.Show("Sample Bag Made !!!", "Record", MessageBoxButtons.OK, MessageBoxIcon.Information)
                txtSample.Enabled = False
                btnDelete.Enabled = False
            End If
            ...
            If CheckBhukaBag(txtTransNo.Text.Trim) = False And CheckSampleBag(txtTransNo.Text.Trim) = False Then        ''Check Sample And Bhuka Bag Made
                MessageBox.Show("Bhuka And Sample Bag Made !!!", "Record", MessageBoxButtons.OK, MessageBoxIcon.Information)
                txtBhukaWt.Enabled = False
                txtSample.Enabled = False
                btnDelete.Enabled = False
            End If
            ...
            If txtOprationType.Tag = 4 Then
                If CheckVacuumBag(txtTransNo.Text.Trim()) = False Then    ''Checking Vacuum Bag 
                    MessageBox.Show("Vaccum Bag Made !!!", "Record", MessageBoxButtons.OK, MessageBoxIcon.Information)
