...
Public Class frmStockBhukaBagCreated
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmStockBhukaBagCreated_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Function
    Private Sub frmStockBhukaBagCreated_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
