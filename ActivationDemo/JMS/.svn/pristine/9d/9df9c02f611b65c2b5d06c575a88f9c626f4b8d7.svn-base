...
Public Class frmAcctOpInterDeptIssue
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper(ConfigurationManager.ConnectionStrings("ConString").ToString())
    Private Sub frmAcctOpInterDeptIssue_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub frmAcctOpInterDeptIssue_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
        Try
