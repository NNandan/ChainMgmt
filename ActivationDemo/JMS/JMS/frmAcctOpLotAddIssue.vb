...
Public Class frmAcctOpLotAddIssue
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper(ConfigurationManager.ConnectionStrings("ConString").ToString())
    Private Sub frmAcctOpLotAddIssue_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Function FetchAllRecords() As DataTable
        ...
        Try
            ...
            parameters.Add(dbManager.CreateParameter("@ActionType", "FetchOpStockLotAdditionIssue", DbType.String))
    ...
    Private Sub frmAcctOpLotAddIssue_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
