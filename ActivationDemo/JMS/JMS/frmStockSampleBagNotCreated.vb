...
Public Class frmStockSampleBagNotCreated
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper(ConfigurationManager.ConnectionStrings("ConString").ToString())
    Private Sub frmStockSampleBagNotCreated_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Function
    Private Sub frmStockSampleBagNotCreated_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
