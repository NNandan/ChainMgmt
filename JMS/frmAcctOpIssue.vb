...
Public Class frmAcctOpIssue
    ...
    Private Function FetchAllRecords() As DataTable
        ...
        Try
            ...
            parameters.Add(dbManager.CreateParameter("@ActionType", "FetchOpStockIssue", DbType.String))
    ...
    End Function
    Private Sub frmAcctOpIssue_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
