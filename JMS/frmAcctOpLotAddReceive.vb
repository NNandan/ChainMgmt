...
Public Class frmAcctOpLotAddReceive
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmAcctOpLotAddReceive_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Function FetchAllRecords() As DataTable
        ...
        Try
            ...
            parameters.Add(dbManager.CreateParameter("@ActionType", "FetchOpStockLotAdditionReceive", DbType.String))
    ...
    Private Sub frmAcctOpLotAddReceive_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
