...
Public Class frmCoreAdditionIssueNew
    ...
    Private Sub ChkDuplicateItem()
        ...
        For i = 0 To Me.dgvCore.Rows.Count - 1
            If Convert.ToString(Me.dgvCore.Rows(i).Cells(3).Value) = txtItemName.Text.Trim Then
                i = i + 1
                Found = True
                MsgBox("Core found again", MsgBoxStyle.Information)
                Exit For
            End If
        Next
