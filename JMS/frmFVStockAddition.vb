...
Public Class frmVStockAddition
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmVStockAddition_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        dgvVStockAdd.AutoGenerateColumns = False
        dgvVStockAdd.EnableFiltering = True
        dgvVStockAdd.MasterTemplate.ShowHeaderCellButtons = True
        dgvVStockAdd.MasterTemplate.ShowFilteringRow = False
        dgvVStockAdd.CurrentRow = Nothing
        ...
        Me.dgvVStockAdd.SummaryRowsBottom.Add(totalRow)

        dgvVStockAdd.DataSource = FetchAllFancys()
    End Sub
    ...
    Private Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        Try
            If dgvVStockAdd.RowCount > 0 Then
                Me.Cursor = Cursors.WaitCursor
                dgvVStockAdd.PrintPreview()
            Else
