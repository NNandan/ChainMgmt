...
Public Class frmFVaccumBag
                ...
                If (MsgBox("Are You Sure To Update This Vaccume Bag ?", vbYesNo + vbDefaultButton2 + vbQuestion, "User : " + UserName.Trim()) = vbYes) Then
                    Try
                        If dgvVacuumBag.RowCount > 0 Then
                            ...
                            dbManager.Delete("SP_fVaccumeBag_Update", CommandType.StoredProcedure, parameters.ToArray())
    ...
    Private Sub UpdateSameVaccumeBag()
        ...
        If dgvVacuumBag.Rows.Count > 0 Then
            ...
            Try
                ...
                End With
                dbManager.Update("SP_fVaccumeSameBag_Update", CommandType.StoredProcedure, Dparameters.ToArray())
        ...
        Try
            ...
            If dtData.Rows.Count > 0 Then
                ...
                Try
                    Dim sresult As String = String.Empty
                    strSQL = Nothing
                    strSQL = "select tblItemMaster.ItemName from tblfNewLotNo inner join tblItemMaster ON tblItemMaster.ItemCode=tblfNewLotNo.BagId where tblfNewLotNo.VaccumeBagNo='" + Convert.ToString(cmbRBagNo.Text) + "'"
                    sresult = Convert.ToString(dbManager.GetScalarValue(strSQL, CommandType.Text))
    ...
    Private Function fetchAllDetails(ByVal sBagNo As String) As DataTable
        ...
        Try
            ...
            dtData = dbManager.GetDataTable("SP_fVaccumeBagSave_Select", CommandType.StoredProcedure, parameters.ToArray())
