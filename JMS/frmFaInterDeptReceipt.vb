...
Public Class frmFaInterDeptReceipt
    ...
    Private Sub bindListView()
        ...
        'RadGridView1.Items.Clear()
        'For i As Integer = 0 To dtable.Rows.Count - 1
        '    Dim drow As DataRow = dtable.Rows(i)
        '    If drow.RowState <> DataRowState.Deleted Then
        '        Dim lvi As ListViewItem = New ListViewItem(drow("ReceiptDt").ToString())
        ...
        For i As Integer = 0 To dtable.Rows.Count - 1
            ...
            '        lvi.SubItems.Add(drow("ConvPr").ToString())
            '        lvi.SubItems.Add(drow("FineWt").ToString())
            '        lvi.SubItems.Add(drow("ForMelting").ToString())
            '        lvi.SubItems.Add(drow("StockAdd").ToString())
            '        RadGridView1.Rows.Add(lvi)
            '        'RadGridView1.DataSource = dtable
            '    End If
        Next
    ...
    Private Sub RadGridView1_CellDoubleClick(sender As Object, e As GridViewCellEventArgs) Handles RadGridView1.CellDoubleClick
        If RadGridView1.Rows.Count > 0 Then
            Try
                ...
                Dim ReceiptId As Integer = RadGridView1.Rows(e.RowIndex).Cells(0).Value.ToString()
                Me.Clear_Form()
