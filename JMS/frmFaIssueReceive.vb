...
Public Class frmFaIssueReceive
    ...
    Private Sub btnFinalize_Click(sender As Object, e As EventArgs) Handles btnFinalize.Click
        ...
        Try
            ...
            Dim frm As New frmFaFinalizeLot(sLotNo, iOpId, dLossAllowed)
            frm.ShowDialog()
            frm.BringToFront()
            frm.Focus()
        Catch ex As Exception
            ...
            If e.RowIndex >= 0 And dgvIssue.Rows(e.RowIndex).Cells(0).Value <> Nothing Then
                ...
                Else
                    ...
                    Try
                        ...
                        ' Next
                        Me.Close()
                        Dim Objfrm As New frmFaReceiveGoldOthers(sLotNo, MaterialId, IssueId, ItemId)
                        Objfrm.ShowDialog()
                        Objfrm.BringToFront()
                        Objfrm.Focus()
                    Catch ex As Exception
...
ErrHandler:
            ...
            If e.RowIndex >= 0 And dgvReceive.Rows(e.RowIndex).Cells(0).Value <> Nothing Then
                ...
                Else
                    ...
                    Try
                        ...
                        Dim Objfrm As New frmFaReceiveGoldOthers(sLotNo, MaterialId, ReceiveId)
                        Objfrm.ShowDialog()
                        Objfrm.BringToFront()
                        Objfrm.Focus()
                        Me.Close()
    ...
    Private Sub btnRecGold_Click(sender As Object, e As EventArgs) Handles btnRecGold.Click
        ...
        Try
            sLotNo = cmbLotNo.Text.Trim
            Dim Objfrm As New frmFaReceiveGoldOthers(sLotNo)
            Objfrm.ShowDialog()
            Objfrm.BringToFront()
            Objfrm.Focus()
        Catch ex As Exception
