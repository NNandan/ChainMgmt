...
Public Class frmFaLotNowiseLossRpt
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmLotNowiseLossRpt_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Me.rdgvLossRpt.GroupDescriptors.Add(New GroupDescriptor("colLotNo"))
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        End Try
    End Sub
    Private Sub frmLotNowiseLossRpt_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
