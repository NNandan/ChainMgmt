...
Public Class frmFaMStockRemoval
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmMStockRemoval_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        dgvMStockRemv.AutoGenerateColumns = False
        dgvMStockRemv.EnableFiltering = True
        dgvMStockRemv.MasterTemplate.ShowHeaderCellButtons = True
        dgvMStockRemv.MasterTemplate.ShowFilteringRow = False
        dgvMStockRemv.CurrentRow = Nothing
        ...
        Me.dgvMStockRemv.SummaryRowsBottom.Add(totalRow)

        dgvMStockRemv.DataSource = FetchAllFancys()
    End Sub
    ...
    Private Sub BtnPrint_Click(sender As Object, e As EventArgs) Handles BtnPrint.Click
        Try
            If dgvMStockRemv.RowCount > 0 Then
                Me.Cursor = Cursors.WaitCursor
                dgvMStockRemv.PrintPreview()
            Else
