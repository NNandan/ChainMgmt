...
Public Class frmFaMeltingwiseLossRpt
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmMeltingwiseLossRpt_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Me.rdgvLossRpt.GroupDescriptors.Add(New GroupDescriptor("colMeltingValue"))
    ...
    End Function
    Private Sub frmMeltingwiseLossRpt_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
