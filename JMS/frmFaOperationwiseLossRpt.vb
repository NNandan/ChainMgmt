...
Public Class frmFaOperationwiseLossRpt
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmOperationwiseLossRpt_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Me.rdgvLossRpt.GroupDescriptors.Add(New GroupDescriptor("colOperationName"))
        ...
        rdgvLossRpt.DataSource = FetchAllFancys()
    End Sub
    ...
    Private Sub btnExit_Click(sender As Object, e As EventArgs) Handles btnExit.Click
        Me.Close()
    End Sub
    Private Sub rdgvLossRpt_KeyDown(sender As Object, e As KeyEventArgs) Handles rdgvLossRpt.KeyDown
        Try
        ...
        End Try
    End Sub
    Private Sub rdgvLossRpt_ViewCellFormatting(sender As Object, e As CellFormattingEventArgs) Handles rdgvLossRpt.ViewCellFormatting
