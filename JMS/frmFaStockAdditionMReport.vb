...
Public Class frmFaStockAdditionMReport
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmStockAdditionReport_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub fetchStockAdditionDetails()
        ...
        rdgvMelting.DataSource = FetchStockAdditionReport()
    End Sub
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        End Try
    End Sub
    Private Sub frmStockAdditionMeltingReport_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
