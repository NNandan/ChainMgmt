...
Public Class frmFaStockBhukaBagCreated
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmFaStockBhukaBagCreated_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub btnExit_Click(sender As Object, e As EventArgs) Handles btnExit.Click
        Me.Close()
    End Sub
    Private Sub dgvWipLotNo_ViewCellFormatting(sender As Object, e As Telerik.WinControls.UI.CellFormattingEventArgs) Handles dgvWipLotNo.ViewCellFormatting
        ...
        End If
    End Sub
    Private Sub dgvWipLotNo_KeyDown(sender As Object, e As KeyEventArgs) Handles dgvWipLotNo.KeyDown
        Try
