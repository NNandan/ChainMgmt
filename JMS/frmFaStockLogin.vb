...
Public Class frmFaStockLogin
    ...
    Private Sub BtnStockLogin_Click(sender As Object, e As EventArgs) Handles BtnStockLogin.Click
        ...
        Try
            ...
            If dtData.Rows.Count > 0 Then
                Me.Hide()
                Dim ObjScrapBagNotUpdate As New frmFaDailyStockDetails
    ...
    Private Sub frmStockLogin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
