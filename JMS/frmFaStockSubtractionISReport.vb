...
Public Class frmFaStockSubtractionISReport
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmStockAdditionISReport_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub StockSubtractionDetails()
        ...
        rdgvIssueReceive.DataSource = FetchStockSubtractionReport()
    End Sub
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        End Try
    End Sub
    Private Sub frmStockAdditionISReport_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
