...
Public Class frmFaStockSubtractionVSReport
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmStockAdditionVSReport_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub StockSubtractionDetails()
        ...
        rdgvVoucher.DataSource = FetchStockSubtractionReport()
    End Sub
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        End Try
    End Sub
    Private Sub frmStockAdditionVSReport_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
