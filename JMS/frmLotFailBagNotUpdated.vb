...
Public Class frmLotFailBagNotUpdated
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmLotFailBagNotUpdated_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim totalOpName As GridViewSummaryItem = New GridViewSummaryItem("colItemName", "Total", GridAggregateFunction.Count)
    ...
    End Function
    Private Sub frmLotFailBagNotUpdated_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
