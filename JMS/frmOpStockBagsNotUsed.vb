...
Public Class frmOpStockBagsNotUsed
    ...
    Private Property Fr_Mode() As FormState
        ...
        End Set
    End Property
    Private Sub frmOpStockBagsNotUsed_Load(sender As Object, e As EventArgs) Handles Me.Load
        Me.Clear_Form()
        Me.filltemName()
    End Sub
    ...
    Sub fillGrid()
        ...
        Else
            ...
            dgvUsedBags.Rows(TempRow).Cells(8).Value = Format(CDbl(txtReportPr.Text.Trim), "0.00")
    ...
    Private Sub dgvUsedBags_CellDoubleClick(sender As Object, e As GridViewCellEventArgs) Handles dgvUsedBags.CellDoubleClick
        Try
            ...
            If e.RowIndex >= 0 And dgvUsedBags.Rows(e.RowIndex).Cells(0).Value <> Nothing Then
                ...
                txtReportPr.Text = dgvUsedBags.Rows(e.RowIndex).Cells(7).Value.ToString()
                TempRow = e.RowIndex
                cmbItem.Focus()
            End If
    ...
    End Sub
    Private Sub txtReportPr_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles txtReportPr.Validating
        Try
        ...
        End Try
    End Sub
    Private Sub frmOpStockBagsNotUsed_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
