...
Public Class frmStockBhukaBagNotCreated
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmStockBhukaBagNotCreated_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Function
    Private Sub frmStockBhukaBagNotCreated_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
