...
Public Class frmStockDeptIssue
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper(ConfigurationManager.ConnectionStrings("ConString").ToString())
    Private Sub frmStockDeptIssue_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Sub
    Private Sub frmStockDeptIssue_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
