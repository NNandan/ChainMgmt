...
Public Class frmStockLossMetalReceived
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmStockLossMetalReceived_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Function
    Private Sub frmStockLossMetalReceived_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
