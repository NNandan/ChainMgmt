...
Public Class frmStockMetalUnused
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmStockMetalUnused_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Function
    Private Sub frmStockMetalUnused_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
