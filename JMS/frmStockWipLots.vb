...
Public Class frmStockWipLots
    Dim strReportName As String = Nothing
    Dim dbManager As New SqlHelper()
    Private Sub frmStockWipLots_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    End Function
    Private Sub frmStockWipLots_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
